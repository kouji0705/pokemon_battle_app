...
// in pokemon_battle_app/test/domain/services/battle_service_test.dart.
...
import 'package:pokemon_battle_app/domain/entities/pokemon.dart' as _i2;
...
class MockPokemonRepository extends _i1.Mock implements _i3.PokemonRepository {
  ...
  @override
  _i4.Future<_i2.Pokemon> getPokemon(String? name) => (super.noSuchMethod(
        Invocation.method(
          #getPokemon,
          [name],
        ),
